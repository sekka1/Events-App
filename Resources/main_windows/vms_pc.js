////////////////////////////////////////////////////
// This view shows total programs
////////////////////////////////////////////////////
...
// in the state for this view
    for (var i = 0; ( i < json_array.currentProgramStates.length ) && ( i < 29 ); i++)
    {
        ...
        if( json_array.currentProgramStates[i].i > 0 ){
        
            // Vars used for this view
            var vms_pn = json_array.currentProgramStates[i].pn;
            var vms_g = json_array.currentProgramStates[i].i;
            var vms_i = json_array.currentProgramStates[i].i;
