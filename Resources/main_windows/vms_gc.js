...
// This is the event listener that opens the page with what probes are watching this channel
// When a program row is clicked the program name parameter will be passed to this eventListener
// and then it will be passed into the new window that is opened for it to run the query        
