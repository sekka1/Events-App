////////////////////////////////////////////////////
// This view shows the program in error state
////////////////////////////////////////////////////
...
Ti.API.info("vms_ec.js json array: " + win.ivms_json);
...
// in the state for this view
    for (var i = 0; ( i < json_array.currentProgramStates.length ) && ( i < 29 ); i++)
    {
        ...
        Ti.API.info( "a count for " + json_array.currentProgramStates[i].pn + " : " + json_array.currentProgramStates[i].a );
    
        // Only show vars that are in good state
        if( json_array.currentProgramStates[i].a > 0 ){
            ...
            var vms_g = json_array.currentProgramStates[i].a;  // State
            ...
            var label_count_info = Titanium.UI.createLabel({  
                text: vms_g + " out of " + vms_i + " are in Error state",  
                left: 54,  
                top: 0,  
                bottom: 2,  
                height: 'auto',  
            ...
            Ti.API.info("index: " + i ); // Get the index number that the user clicked on
            Ti.API.info("program name: " + vms_pn ); // program the user clicked on
        }
