...
// in simulator we redefine to format for smurf Developer console
...
{\
	NSString * exceptionName = [@"org.smurf." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smurf";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIsmurfNativeItemNone = -1, 
	UIsmurfNativeItemSpinner = -2,
	UIsmurfNativeItemProgressBar = -3,
	
	UIsmurfNativeItemSlider = -4,
	UIsmurfNativeItemSwitch = -5,
	UIsmurfNativeItemMultiButton = -6,
	UIsmurfNativeItemSegmented = -7,
	
	UIsmurfNativeItemTextView = -8,
	UIsmurfNativeItemTextField = -9,
	UIsmurfNativeItemSearchBar = -10,
	
	UIsmurfNativeItemPicker = -11,
	UIsmurfNativeItemDatePicker = -12,
	
	UIsmurfNativeItemInfoLight = -13,
	UIsmurfNativeItemInfoDark = -14,
	
	UIsmurfNativeItemDisclosure = -15,
	
	UIsmurfNativeItemContactAdd = -16
};
